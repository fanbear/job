...
class ControllerExtensionModuleQuickviewpro extends Controller {
	...
	public function index() {
		...
		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/quickviewpro', 'token=' . $this->session->data['token'], 'SSL');
		} else {
		...
		$this->response->setOutput($this->load->view('extension/module/quickviewpro.tpl', $data));
	}
