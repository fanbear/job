...
class ControllerTotalDiscountSales extends Controller { 
	private $error = array();
        private $this_version = '1.9.0.0';
        private $this_extension = 'ocext_discountsales';
		...
		if (isset($this->request->post['discountsales_status'])) {
			...
			$data['discountsales_category_sort_order'] = $this->config->get('discountsales_category_sort_order');
                ...
                /*
                if($this->config->get('discountsales_promo_to_product')){
			$data['discountsales_promo_to_product'] = $this->config->get('discountsales_promo_to_product');
		}
                
                $data['discountsales_promo']['discount'] = array();
                if($this->config->get('discountsales_promo_discount')){
			$data['discountsales_promo_discount'] = $this->config->get('discountsales_promo_discount');
		}
                $data['discountsales_promo']['category'] = array();
                if($this->config->get('discountsales_promo_category')){
			$data['discountsales_promo_category'] = $this->config->get('discountsales_promo_category');
		}
                $data['discountsales_promo']['manufacturer'] = array();
                if($this->config->get('discountsales_promo_manufacturer')){
			$data['discountsales_promo_manufacturer'] = $this->config->get('discountsales_promo_manufacturer');
		}
                 * 
                 */
                ...
                //var_dump($data['discountsales_promo']);
