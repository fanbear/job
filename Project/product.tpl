              ...
              <?php if ($attribute_groups) { ?>
                <?php foreach ($attribute_groups as $attribute_group) { ?>
                    <?php foreach ($attribute_group['attribute'] as $attribute) { ?>
                        <?php if(in_array($attribute['attribute_id'], array(193,196,200,194))) { ?>
                ...
                <!--  -->
                 <!-- ------------------------------------------Кнопки ----------------------------------------------------------------- -->
                  ...
                  <div class="btn-product-group">
                        ...
                        <button type="button" id="credit" data-toggle="tooltip" title="Купить в кредит">КУПИТЬ В КРЕДИТ</button>
