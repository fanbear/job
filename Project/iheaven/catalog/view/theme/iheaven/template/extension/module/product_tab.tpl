      ...
      <div id="tabs-<?php echo $module; ?>" class="htabs">
        ...
        <ul class="nav nav-tabs">
          <?php if($featured_products){ ?>
            <li><a href="#tab-featured-<?php echo $module; ?>" data-toggle="tab" class="selected"><p>ХИТЫ ПРОДАЖ<!-- <?php echo $tab_featured; ?> --></p></a></li>
          <?php } ?>
          
          <?php if($bestseller_products){ ?>
            <li class="active"><a href="#tab-bestseller-<?php echo $module; ?>" data-toggle="tab"><p><?php echo $tab_bestseller; ?></p></a></li>
          <?php } ?>
          
            <?php if($latest_products){ ?>
              <li><a href="#tab-latest-<?php echo $module; ?>" data-toggle="tab"><p><?php echo $tab_latest; ?></p></a></li>
            <?php } ?>
          
          <?php if($special_products){ ?>
            <li><a href="#tab-special-<?php echo $module; ?>" data-toggle="tab"><p>РАСПРОДАЖА<!-- <?php echo $tab_special; ?> --></p></a></li>
          <?php } ?>
       </ul>
    </div>
