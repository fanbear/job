<input type="text" name="smca_reward" value="<?php echo $reward; ?>" placeholder="<?php echo $entry_reward; ?>" id="smca-input-reward" />
<input type="submit" value="<?php echo $button_reward; ?>" id="smca-button-reward" data-loading-text="<?php echo $text_loading; ?>"  class="next-step-button" />
