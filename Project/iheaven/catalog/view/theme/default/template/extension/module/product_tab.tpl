  <div id="tabs-<?php echo $module; ?>" class="htabs">
	...
	<a href="#tab-featured-<?php echo $module; ?>" data-toggle="tab" class="selected"><h3><?php echo $tab_featured; ?></h3></a></li>
	<?php } ?>
	
	<?php if($bestseller_products){ ?>
	<li>
	<a href="#tab-bestseller-<?php echo $module; ?>" data-toggle="tab"><h3><?php echo $tab_bestseller; ?></h3></a></li>
	<?php } ?>
	
  <?php if($latest_products){ ?>
  <li>
  <a href="#tab-latest-<?php echo $module; ?>" data-toggle="tab"><h3><?php echo $tab_latest; ?></h3></a></li>
  <?php } ?>
  
	<?php if($special_products){ ?>
	<li>
	<a href="#tab-special-<?php echo $module; ?>" data-toggle="tab"><h3><?php echo $tab_special; ?></h3></a></li>
	<?php } ?>
	</ul>
 </div>
