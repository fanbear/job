...
class ControllerExtensionModuleOCdevSmartCart extends Controller {
  ...
  public function index() {
    ...
    $models = array('catalog/product', 'tool/image', 'tool/upload', 'extension/extension', 'extension/module/'.self::$_module_name);
  ...
  public function saveCart() {
    ...
    // connect models array
    $models = array('extension/module/'.self::$_module_name, 'extension/extension', 'tool/image', 'tool/upload');
    foreach ($models as $model) {
      $this->load->model($model);
    }
