  ...
  <div class="row">
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="timer">
        <p>СКИДКИ ДО 30% !!!</p>
        <div class="dat">
          <!-- <small>Акции продлится:</small>
          <strong>04.09.2019 - 04.10.2019</strong> -->
          <img src="/image/catalog/actcii/naakcii.png" class="img-responsive" alt="">
        </div>
        <div class="button"><a href="https://iheaven.com.ua/specials/">Посмотреть все акции</a></div>
        <div class="timer-text">
          <p>В нашем интернет-магазине Вы можете купить оригинальные смартфоны от производителей с гарантией по очень приятным ценам. В интернет-магазине представлен большой ассортимент аксессуаров. Также Вы можете купить технику с доставкой по Украине. Переходите по ссылке на наши социальные сети. 
        </p>
        </div>
      </div>
    </div>
