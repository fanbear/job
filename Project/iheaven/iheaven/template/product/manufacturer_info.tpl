      ...
      <div class="row">
        ...
        <div class="product-layout product-list col-xs-12 pr-t">
          <div class="product-thumb">
            <!-- ---------------------------------------------------------------------------- -->
              <div class="col-sm-10 col-xs-10 p-name"><p><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></p></div>
              <div class="col-sm-2 col-xs-2 wishlist"><button type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><img src="https://chaspick.com.ua/image/catalog/whishilist.png" alt="Список желаемых"></button>
              </div>
            <!-- ----------------------------------------------------------------------------- -->
